all: core alu regfile memory signextend CPU_unit CPU_fib CPU_while

### CPU Module
CPU_unit: CPU.v CPU_unit.t.v
	iverilog -Wall -o CPU_unit CPU_unit.t.v

CPU_fib: CPU.v CPU_fib.t.v
	iverilog -Wall -o CPU_fib CPU_fib.t.v
